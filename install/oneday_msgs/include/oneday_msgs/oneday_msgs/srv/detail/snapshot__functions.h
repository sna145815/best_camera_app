...
#ifndef ONEDAY_MSGS__SRV__DETAIL__SNAPSHOT__FUNCTIONS_H_
#define ONEDAY_MSGS__SRV__DETAIL__SNAPSHOT__FUNCTIONS_H_
...
/// Initialize srv/Snapshot message.
/**
...
/// Create srv/Snapshot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * oneday_msgs__srv__Snapshot_Request__init().
...
/// Destroy srv/Snapshot message.
/**
 * It calls
 * oneday_msgs__srv__Snapshot_Request__fini()
...
/// Check for srv/Snapshot message equality.
/**
...
/// Initialize array of srv/Snapshot messages.
/**
...
/// Finalize array of srv/Snapshot messages.
/**
 * It calls
 * oneday_msgs__srv__Snapshot_Request__fini()
...
/// Create array of srv/Snapshot messages.
/**
 * It allocates the memory for the array and calls
 * oneday_msgs__srv__Snapshot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Snapshot messages.
/**
 * It calls
 * oneday_msgs__srv__Snapshot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Snapshot message array equality.
/**
...
/// Copy an array of srv/Snapshot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * oneday_msgs__srv__Snapshot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_oneday_msgs
...
/**
 * It calls
 * oneday_msgs__srv__Snapshot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_oneday_msgs
...
/**
 * It allocates the memory for the array and calls
 * oneday_msgs__srv__Snapshot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_oneday_msgs
...
/**
 * It calls
 * oneday_msgs__srv__Snapshot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ONEDAY_MSGS__SRV__DETAIL__SNAPSHOT__FUNCTIONS_H_
